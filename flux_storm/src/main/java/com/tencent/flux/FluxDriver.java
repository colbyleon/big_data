...
//        System.setProperty("hadoop.home.dir", "D:\\GreenSoft\\hadoopbin_for_hadoop2.7.1");
        ...
        // 1.创建组件
        BrokerHosts hosts = new ZkHosts("192.168.88.61:2181,192.168.88.62:2181,192.168.88.63:2181");
        ...
        builder.setBolt("CLEAR_BOLT", new ClearBolt()).shuffleGrouping("KAFKA_SPOUT");
        builder.setBolt("PV_BOLT", new PvBolt()).shuffleGrouping("CLEAR_BOLT");
        builder.setBolt("UV_BOLT", new UvBolt()).shuffleGrouping("PV_BOLT");
        builder.setBolt("VV_BOLT", new VvBolt()).shuffleGrouping("UV_BOLT");
        builder.setBolt("NEW_IP_BOLT", new NewIpBolt()).shuffleGrouping("VV_BOLT");
        builder.setBolt("NEW_CUST_BOLT", new NewCustBolt()).shuffleGrouping("NEW_IP_BOLT");
        builder.setBolt("TO_MYSQL_BOLT", new ToMysqlBolt()).shuffleGrouping("NEW_CUST_BOLT");
        builder.setBolt("TO_HBASE_BOLT", new ToHBaseBolt()).shuffleGrouping("NEW_CUST_BOLT");
        builder.setBolt("PRINT_BOLT", new PrintBolt()).shuffleGrouping("NEW_CUST_BOLT");
...
//        config2.put(Config.TOPOLOGY_TICK_TUPLE_FREQ_SECS, 5);
        ...
        StormSubmitter.submitTopology("FLUX_TOPOLOGY2", config, builder2.createTopology());
